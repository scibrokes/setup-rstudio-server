...
|:-------------------------------------------------------------------------------------------------|----------------------|-----------------------------------------|------------------------------|------------------------------:|
| [DigitalOcean](https://m.do.co/c/aabb124120d0)                                                    |     手动由始开始安装 |        所有自主权，可以自行添加任何会员 |                月租由5美元起 | 支持大数据分析                |
...
### 第1.1章 : 选择网络虚拟操作系统
  ...
  首先您可以网络选择虚拟操作系统，[何谓网络服务器](http://baike.baidu.com/view/460250.htm)在下就不多说。今儿就介绍一下这 [DigitalOcean.com](https://m.do.co/c/aabb124120d0)，您亦可选择：
...
![*figure-1.1.1 : create a droplet*](figure/create-droplet.gif)
  ...
  大约几分钟时间建立了Droplet后，系统将会显示个ip地址：[46.101.160.242](http://46.101.160.242)（好比您の虚拟公司地址），然后建议您造访[PuTTY](http://www.putty.org/) 网站，并下载个独立工具来管理网络构建の虚拟操作系统，您亦可直接在网站上运行代码。（您亦可通过谷歌随意搜索并使用个网络版SSH即可，没有任何软件限制）您亦可在**Saved Sessions**随意填写个名字后**Save**，以方便以后每次打开PuTTYの时候，直接选择该**Session**后**Load**，那么就无需时时记得ip，每次都得输入ip。
...
#### nginx网络服务器の设定
  ...
  - 有关详细のCentOS上安装nginx并提供nginx设置の教程，请参阅[Nginxの安装と配置](http://yidao620c.github.io/blog/20151120/nginx.html)。
...
![*figure-4.2.2 : create a rmarkdown sample 2*](figure/rmarkdown_2.gif)
  ...
  除此之外，您也可以安装[rticles](https://github.com/rstudio/rticles)程序包哦！您还可以通过添加YAML和CSS在您的R Markdown文件上以设置网页外观と格式，有关YAML请参阅[Yaml入门笔记](http://yidao620c.github.io/blog/20150522/yaml-introduce.html)。
...
### 第5.2章 : 统计学とR
  ...
  倘若您の数据太大，您可以安装Hadoop或者sparkR，您可以参阅[centos6上安装HadoopとHBase](http://yidao620c.github.io/blog/20150527/hadoop-hbase.html)以了解如何安装。它日会再分享统计学相关文章，您可以先参考以下一些统计学相关书籍：
