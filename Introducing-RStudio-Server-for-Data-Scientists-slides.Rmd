...
#### nginx网络服务器の设定
  ...
  - 有关详细のCentOS上安装nginx并提供nginx设置の教程，请参阅[Nginx的安装和配置](http://yidao620c.github.io/blog/20151120/nginx.html)。
...
![GNOME Desktop](figure/GNOME-desktop.jpg)
  ...
  * [How to install Desktop Environments on CentOS 7?](http://unix.stackexchange.com/questions/181503/how-to-install-desktop-environments-on-centos-7)
  ...
  由于在网页上操作太不方便了，故此您还可以设置个远程桌面，详情请参阅[How To Install and Configure VNC Remote Access for the GNOME Desktop on CentOS 7](https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-vnc-remote-access-for-the-gnome-desktop-on-centos-7?comment=35734)。它日会再分享更多centOS操作系统专页文章。
...
### 第5.2章 : 统计学とR
  ...
  倘若您的数据太大，您可以安装Hadoop或者sparkR，您可以参阅[centos6上安装Hadoop和HBase](http://yidao620c.github.io/blog/20150527/hadoop-hbase.html)以了解如何安装。它日会再分享统计学相关文章，您可以先参考以下一些统计学相关书籍：
